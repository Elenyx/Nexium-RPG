const commonCharacters = [
  {
    ...
    anime: 'Naruto',
    rarity: 'COMMON',
    image: 'https://ik.imagekit.io/NexiumRPG/Characters/NC001.png',
    baseStats: {
      health: 1200,
      attack: 150,
      defense: 100,
...

  {
    ...
    anime: 'Naruto',
    rarity: 'COMMON',
    image: 'https://ik.imagekit.io/NexiumRPG/Characters/NC002.png',
    baseStats: {
      health: 1100,
      attack: 180,
      defense: 90,
...

  {
    ...
    anime: 'Naruto',
    rarity: 'COMMON',
    image: 'https://ik.imagekit.io/NexiumRPG/Characters/NC003.png',
    baseStats: {
      health: 1300,
      attack: 120,
      defense: 140,
...

  {
    ...
    anime: 'Naruto',
    rarity: 'COMMON',
    image: 'https://ik.imagekit.io/NexiumRPG/Characters/NC004.png',
    baseStats: {
      health: 1000,
      attack: 100,
      defense: 80,
...

  {
    ...
    anime: 'Naruto',
    rarity: 'COMMON',
    image: 'https://ik.imagekit.io/NexiumRPG/Characters/NC005.png',
    baseStats: {
      health: 1050,
      attack: 95,
      defense: 85,
...

  {
    ...
    anime: 'Naruto',
    rarity: 'COMMON',
    image: 'https://ik.imagekit.io/NexiumRPG/Characters/NC006.png',
    baseStats: {
      health: 1150,
      attack: 85,
      defense: 95,
...

  {
    ...
    anime: 'Naruto',
    rarity: 'COMMON',
    image: 'https://ik.imagekit.io/NexiumRPG/Characters/NC007.png',
    baseStats: {
      health: 1250,
      attack: 140,
      defense: 110,
